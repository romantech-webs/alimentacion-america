  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="alimentacion-america";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Alimentación América"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="alimentacion-america"
          data-primary-color="#a98752"
          defer
        ></script>
      </head>
